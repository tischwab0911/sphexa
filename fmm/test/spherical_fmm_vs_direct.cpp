...
/*! @file
 * @brief Test spherical harmonic FMM (dual traversal) against direct sum
 *
...
TEST(SphericalFMM, VsDirectSum)
{
    ...
    std::cout << "Spherical FMM (P=" << fmm::ExpansionOrder << ") for " << numParticles << " particles: " << elapsed
              << " s" << std::endl;
